        ...
        <form method="POST" action="{{ route('landing.login') }}">
            ...
            <div class="grid gap-6">
                ...
                <div class="flex items-center justify-between">
                    <label for="remember_me" class="inline-flex items-center">
                        <input id="remember_me" type="checkbox"
                            class="text-gray-800 border-gray-300 rounded focus:border-blue-300 focus:ring focus:ring-blue-500 dark:border-gray-600 dark:bg-dark-eval-1 dark:focus:ring-offset-dark-eval-1"
                            name="remember">
                ...
                <p class="text-sm text-gray-600 dark:text-gray-400">
                    ...
                    <a href="{{ route('landing.register') }}" class="text-blue-500 hover:underline">
                        {{ __('Register') }}
                    </a>
                </p>
            </div>
