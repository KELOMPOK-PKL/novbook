            ...
            <form class="mt-28">
                <div class="-mx-2 md:items-center md:flex">
                    <div class="flex-1 px-2">
                        ...
                        <input type="text" placeholder="Ndaru Victor" class="block w-full px-5 py-3 mt-2 text-gray-700 placeholder-gray-400 bg-slate-50 border border-gray-300 rounded-md dark:placeholder-gray-600 dark:bg-gray-900 dark:text-gray-300 dark:border-gray-700 focus:border-blue-400 dark:focus:border-blue-400 focus:ring-blue-400 focus:outline-none focus:ring focus:ring-opacity-40" />
                    </div>

                    <div class="flex-1 px-2 mt-4 md:mt-0">
                        <label class="block mb-2 text-sm text-gray-600 dark:text-gray-200 font-semibold">Email address</label>
                        <input type="email" placeholder="ndaruvictor@gmail.com" class="block w-full px-5 py-3 mt-2 text-gray-700 placeholder-gray-400 bg-slate-50 border border-gray-300 rounded-md dark:placeholder-gray-600 dark:bg-gray-900 dark:text-gray-300 dark:border-gray-700 focus:border-blue-400 dark:focus:border-blue-400 focus:ring-blue-400 focus:outline-none focus:ring focus:ring-opacity-40" />
                    </div>
                </div>
                ...
                <button class="px-6 py-2 mt-5 font-medium tracking-wide text-white capitalize transition-colors duration-300 transform bg-blue-600 rounded-lg hover:bg-blue-500 focus:outline-none focus:ring focus:ring-blue-300 focus:ring-opacity-80">
                    SUBMIT
                </button>
            </form>
        </div>
            ...
            <div class="grid grid-cols-1 gap-12 mt-10 lg:grid-cols-3">
                <div class="grid grid-cols-1 gap-12 sm:grid-cols-2 lg:grid-cols-1">
                    ...
                    <div>
                        ...
                        <p class="mt-2 text-sm text-blue-500 dark:text-blue-400">Vistech Software House, Jalan Satsui Tubun, Gadang, Kota Malang, Jawa Timur</p>
                    </div>
                ...
                <div class="overflow-hidden rounded-lg lg:col-span-2 h-96 lg:h-auto">
                    <iframe width="100%" height="100%" frameborder="0" title="map" marginheight="0" marginwidth="0" scrolling="no" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3950.789259394256!2d112.62377797374994!3d-8.020654080051852!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2dd7ff6464e13253%3A0x2fb0543a5667d6fb!2sVistech%20Software%20House!5e0!3m2!1sid!2sid!4v1687146022251!5m2!1sid!2sid"></iframe>
                </div>
            </div>
        </div>
    </section>
