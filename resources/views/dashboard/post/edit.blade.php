                ...
                <div class="p-6 text-gray-900 dark:text-gray-100 overflow-x-auto">
                    <form action="{{ route('post.update', $post->id) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="my-3">
                            ...
                            <x-text-input id="nama" placeholder="Input_Name" class="block mt-1 w-full"
                                type="text" name="name" :value="$post->name" />
                            @error('name')
                        ...
                        <div class="my-3">
                            ...
                            <x-text-input id="title" placeholder="Input_Title" class="block mt-1 w-full"
                        ...
                        <div class="mb-3">
                            ...
                            <br>
                            <img src="{{ asset('storage/' . $post->image) }}" width="100px" class="img-fluid"
                                alt="...">
                        </div>
                        <div class="my-3">
                        ...
                        <div class="mb-3">
                            ...
                            <br>
                            <embed src="{{ asset('storage/' . $post->Pdf) }}" width="100px"
                                alt="...">
                        </div>
                        <div class="my-3">
