...
@php
    ...
    switch ($variant) {
        ...
        case 'danger':
            ...
            break;
        case 'warning':
            $variantClasses = 'bg-yellow-400 text-white hover:bg-yellow-600 focus:ring-yellow-500';
            break;
        case 'info':
        ...
        case 'black':
            ...
            break;
        case 'ligth':
            $variantClasses = 'bg-yellow-300  text-gray-900 border border-yellow-200 focus:outline-none hover:bg-yellow-200 focus:ring-4 focus:ring-yellow-300';
            break;
        default:
